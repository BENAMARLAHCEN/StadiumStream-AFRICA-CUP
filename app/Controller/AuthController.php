        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST' && $_POST['submit'] == 'regester') {
            ...
            if (count($errors) == 0) {
                ...
                if ($this->user->registerUser()) {
                    $generatedToken = substr(uniqid(), 0, 8);
                    ...
                    <span style='color: red; font-size: 30px; font-weight: bold;'>" . $generatedToken . "</span><br><br>
                    ...
                    $this->user->insertToken($generatedToken,$email);
                    echo $generatedToken;
                    exit;
                    header("location:" . APP_URL);
                }
