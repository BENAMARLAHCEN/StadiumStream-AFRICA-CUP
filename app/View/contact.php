            ...
            <div class="col-lg-6 " >
              <div class="card-body " >
                ...
                <div class="card px-5 py-4">
                  ...
                  <div class="mb-3">
                      <input type="usename" class="form-control p-2 " id="username" placeholder="username">
                  </div>

                  <div class="mb-3">
                      <input type="email" class="form-control p-2" id="email" placeholder="name@example.com">
                  </div>
                  ...
                  <div class="text-center pt-1 mb-5 pb-1">
                    <button class="btn-click btn-block fa-lg gradient-custom-2 mb-3 px-5 py-3" type="button">Send</button>
