...
<section class=" container d-flex justify-content-center mb-5 ">
          <a href="<?=APP_URL?>Reservation/TicketPDF/<?=$data[0]['id']?>" class="btn bg-red"><i class="fa fa-ticket"></i> Get Tickets in PDF</a>
          <a href="<?=APP_URL?>" class="btn bg-green"><i class="fa fa-dot-circle-o"></i>Go back</a>
</section>
