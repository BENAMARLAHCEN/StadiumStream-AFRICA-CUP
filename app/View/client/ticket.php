  ...
  <div class="row">
    ...
    <article class="card fl-left">
      <section class="card-cont position-relative">
        ...
        <small class=" z-1"><?=$row['teamA']?> VS CONGO</small>
        ...
        <div  class=" z-0 opacity-25 w-100 d-flex justify-content-between position-absolute Logo">
            <img class=" w-50" src="<?=APP_URL?>asset/uploads/Image.svg" alt="">
            <img class=" w-50" src="<?=APP_URL?>asset/uploads/Flag_Congo.svg" alt="">
        </div>
        <!-- <a href="#">tickets</a> -->
      </section>
      <section class="date ">
