    ...
    <div class="d-flex justify-content-around align-items-center search-section">
      <div class="col-md-3 m-0">
        <div class="input-group">
          <select name="" class="form-control" id="filterType" onchange="changeFilter()">
            <option value="1">Filter by</option>
            <option value="1">Team</option>
            <option value="2">Statium</option>
          </select>
      ...
      <div class="col-md-4 m-0">
        <div class="input-group" id="searchinput">
          <input oninput="searchbyTeam()" type="search" placeholder="Search by teams " class="form-control" id="search" name="search">
        </div>
      </div>
      <div class="col-md-3 m-0">
        <div class="input-group flex-nowrap">
          <span class="input-group-text"><i class="bi bi-calendar"></i></span>
          <input type="text" class="form-control datelimit"  id="date-range" placeholder="Select Date Range">
        </div>
      </div>
      <div class="m-0">
    ...
    <div class="d-flex flex-row justify-content-between p-3 ">
      ...
      <p class="wiew-all fw-medium">
        ...
        <svg width="8" height="11" viewBox="0 0 8 11" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M1.75 1L6.25 5.5L1.75 10" stroke="#FF7900" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
      </p>
    </div>
...
<script src="<?=APP_URL?>asset/js/ajax.js"></script>