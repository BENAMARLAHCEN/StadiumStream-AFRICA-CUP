<section class="jumbotron jumbotron-fluid hero-section">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-7 mb-6 mb-lg-0">
            <div class="">
              ...
              <!-- btn -->
              <a href="#" class="btn btn-more-info px-4 py-2">MORE INFO</a>
              <a href="#" class="btn btn-gow px-4 py-2">GOW NOW !</a>
              <div class="mt-5">
                <a href="" class="media"
                  ><i class="bi bi-facebook bi-social bg-white w-100%"></i
                ></a>
                <a href="" class="media"
                  ><i class="bi bi-twitter-x bi-social bg-white"></i
                ></a>
                <a href="" class="media"
                  ><i class="bi bi-instagram bi-social bg-white"></i
                ></a>
                <a href="" class="media"
                  ><i class="bi bi-youtube bi-social bg-white"></i
                ></a>
              </div>
            </div>
          </div>
    ...
    <section class="p-5">
      <div class="container">
        <div
          class="container-Search d-flex justify-content-between align-items-center px-4"
        >
          <div
            class="inputSearch d-flex justify-content-start align-items-center"
          >
            <input
              type="search"
              name="search"
              id="saerch"
              placeholder="Search by matchs, teams, stadiums..."
            />
          </div>
          <div
            class="container-date d-flex justify-content-between align-items-center px-4"
          >
    ...
    <section>
      <div class="container">
        ...
        <div class="card01 d-flex flex-row justify-content-between">
              ...
              <div class="card-body p-0">
                <div class="card-body">
                  <div class="d-flex flex-row justify-content-between">
                    <p>14 janvier 2024 à partir de 14h00</p>
          ...
          <div class="card01 d-flex flex-row justify-content-between">
            <div class="card01-border card col-md m-3">
              <img src="<?=APP_URL?>asset/img/match02.svg" class="card-img-top p-2" alt="..." />
              <div class="card-body">
                <div class="card-body p-0">
                  <div class="d-flex flex-row justify-content-between">
                    <p>14 janvier 2024 à partir de 14h00</p>
        ...
        <div class="card01 d-flex flex-row justify-content-between">
          <div class="card01 d-flex flex-row justify-content-between">
            <div class="card01-border card col-md m-3">
              <img src="<?=APP_URL?>asset/img/Match03.svg" class="card-img-top p-2" alt="..." />
              <div class="card-body p-0">
                <div class="card-body">
                  <div class="d-flex flex-row justify-content-between">
                    <p>14 janvier 2024 à partir de 14h00</p>
    ...
    <section class="jumbotron jumbotron-fluid bg-groups">
      <div class="container">
        ...
        <div class="d-flex flex-row justify-content-around align-items-center">
            ...
            <img src="<?=APP_URL?>asset/img/GroupA.svg" alt="" class="card-group"/>
          
         
            <img src="<?=APP_URL?>asset/img/GroupB.svg" alt="" class="card-group"/>
      
         
            <img src="<?=APP_URL?>asset/img/GroupC.svg" alt="" class="card-group"/>
       
        </div>
        <div class="d-flex flex-row justify-content-around align-items-center">
          
            <img src="<?=APP_URL?>asset/img/GroupD.svg" alt="" class="card-group"/>
          
          
            <img src="<?=APP_URL?>asset/img/GroupE.svg" alt="" class="card-group"/>
         
          
            <img src="<?=APP_URL?>asset/img/GroupF.svg" alt="" class="card-group"/>
      ...
      <div class="container">
        ...
        <div class="card02 d-flex flex-row justify-content-between">
          <div class="card02 d-flex flex-row justify-content-between">
            <div class="card02-border col-md m-3">
              ...
              <div class="card-body p-3">
                <div class="card-body">
                  <div
                    class="d-flex flex-row justify-content-between align-items-center pb-3"
                  >
          ...
          <div class="card02 d-flex flex-row justify-content-between">
            <div class="card02-border col-md m-3">
              <img
                src="<?=APP_URL?>asset/img/southAfrica.svg"
          ...
          <div class="card02 d-flex flex-row justify-content-between">
            <div class="card02-border col-md m-3">
              <img
                src="<?=APP_URL?>asset/img/albums_matches_2219397_koo_9 1.svg"
                class="card-img-top p-2"
                alt="..."
              />
              <div class="card-body p-3">
            ...
            <div class="featured-carousel owl-carousel p-3 ">
              <div class="item p-3">
                <div class="blog-entry">
                  <img
                    src="<?=APP_URL?>asset/img/abidjan.svg"
                    class="card-img-top p-2"
                    alt="..."
                  />
                  <div class="p-4">
              ...
              <div class="item p-3">
                <div class="blog-entry">
                  <img
                    src="<?=APP_URL?>asset/img/stade.svg"
                    class="card-img-top p-2"
                    alt="..."
                  />
                  <div class="p-4">
